...
} from '../../plugins/skill-lab/skills/score/scripts/mine'
import { buildAugmentPrompt, parseVariants, attachVariants } from '../../plugins/skill-lab/skills/score/scripts/mine'
